...
function main() {
    ...
    //Get storage location of the u_ViewMatrix and the u_ModelMatrix variables
    ...
    modelMatrix.setRotate(-10, 0, 0, 1); // Rotated around z axis

    //Pass the view and model matrix to the vertex shader
